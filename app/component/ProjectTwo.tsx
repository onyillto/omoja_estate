    ...
    <section className="relative w-full bg-[#800517] py-20 md:py-16">
      <div className="max-w-[1400px] mx-auto px-10 md:px-10 sm:px-5">
        ...
        <div className="mb-16 md:mb-12">
          <span className="text-gray-300 text-[13px] uppercase tracking-[3px] font-medium mb-8 block">
            Iron Root Farm
          </span>
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            <div className="flex-1">
              ...
              <p className="text-gray-200 text-[15px] leading-[26px] max-w-[600px]">
            ...
            <div className="grid grid-cols-2 gap-4 w-full lg:w-auto">
              <div className="bg-[#ffff] border border-gray-800 rounded-lg p-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-[#ffff] border border-gray-800 rounded-2xl p-8 md:p-6">
            ...
            <div className="bg-[#ffff] border border-gray-800 rounded-2xl p-8 md:p-6">
              ...
              <p className="text-[#800517] text-[24px] font-bold">
                ₦5.5M - ₦6.0M
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-[#ffff] border border-gray-800 rounded-2xl p-8 md:p-6">
            <h3 className="text-gray-800 text-[18px] font-semibold mb-6">
        ...
        <div className="flex justify-center">
          <Link
            href="/farm-estates"
            className="group inline-flex items-center gap-3 bg-[#800517] hover:bg-[#6a0413] text-white px-8 py-4 rounded-lg text-[15px] font-medium transition-all duration-300"
          >
